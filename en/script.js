...
const promptList = [
  {
    text: "HTML - \hyper text markup language\" - the most basic building block of the Web. It defines the content and structure of web content. Technologies other than HTML5 are usually used to describe the appearance, presentation, or functionality of a web page.",
    author: 'MDN, Мотвей'
  },
  {
    text: "Hypertext refers to links that connect web pages to each other, either within the same website or between websites. Links are a fundamental aspect of the Web. By uploading content to the Internet and linking it to pages created by other people, you become an active participant in the world wide web.",
    author: 'MDN, Мотвей'
  },
  {
    text: "We have already read a lot of text in this course. Much text. But the web would be boring if it consisted only of text, so let's see how to spice up the web with more interesting content! This module explains how to use HTMLML to insert multimedia into your web pages, including various ways to insert images, videos, audio, and other pages in their entirety.",
    author: 'MDN, Мотвей'
  },
  {
    text: "Hyperlinks are very important. After all, they make the Internet the Internet. This article describes the syntax required for creating links, and describes how best to use them in practice.",
    author: 'MDN, Motvey'
  },
  {
    text: "The elements in HTML have attributes. These are additional values that customize elements or control their behavior in various ways to meet the criteria that users want.",
    author: 'MDN, Мотвей'
  }
]
